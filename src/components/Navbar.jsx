                        ...
                        <div className={`menu-wrapper-lg ${roomPage ? 'passive' : active}`}>
                            <form className={`form-bar ${roomPage ? 'active' : active}`}>
                                ...
                                <div className="user-wrapper wrapper">
                                    ...
                                    <p>Add guest</p>
                                    <button type="submit">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ 'display': 'block', 'height': ' 16px', 'width': '16px', 'stroke': 'currentcolor', 'strokeWidth': '4', ' overflow': 'visible' }}><path fill="none" d="M13 24a11 11 0 1 0 0-22 11 11 0 0 0 0 22zm8-3 9 9"></path></svg>
                                    </button>
                                </div>
                            </form>
                        </div>
                    </ul>
                    <div className={`status-bar ${wishlistPage || roomPage ? '' : 'hidden'}`}>
                        <div className="lang">
                        ...
                        <div className="account-bar" onClick={toggleMenu} ref={menuRef}>
                            <div className="bars">
                            ...
                            <div className={`account-menu ${menuVisible ? 'visible' : ''}`}  >
                                {user ? <div>
                                    <ul>
                                ...
                                <div>
                                    <ul>
                                        {user ? <>
                                            ...
                                            <li><a onClick={() => handleClick('/hosts')}>Host List</a></li>
                                        </> : ""}
                                        {user ? "" :
                                            <li><a onClick={() => handleClick('/register')}>Register</a></li>
                                        }
                                        {user ? <li><a onClick={() => logout()} >Log out</a></li> : <li><a onClick={() => handleClick('/login/0')} >Log in</a></li>}
                                    </ul>
                                </div>
                            </div>
                        </div>
