            ...
            <div className='item-dad'>
              ...
              >
                {item.images.map((item) => (
                  <SwiperSlide className='item-img' key={item.id}><a href='#'><img src={item.url} key={item.id} /></a></SwiperSlide>
                ))}
